...
const ACCOUNT_ACTIVATION_SUCCESS_MESSAGE = 'Account Registered Successfully';
...
const INVALID_CREDENTIALS = 'Account';
const LOGIN_SUCCESS = 'Account login Successfully';
